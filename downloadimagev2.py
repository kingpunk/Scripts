...
save_path= "C:\\Users\\pskavalekar\\Desktop\\DATASET\\InternetDataset"


# What you enter here will be searched for in
# Google Images
query = input("What is the type of object?")
downLoadpath = os.path.join(save_path,query)
